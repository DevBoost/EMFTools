...
/**
 * This is the item provider adapter for a {@link org.emftext.language.mecore.MOperation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MOperationItemProvider
	 ...
	 * @generated
	 */
	public MOperationItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MecorePackage.Literals.MOPERATION__PARAMETERS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MOperation"));
	}
	...
	public String getText(Object object) {
		String label = ((MOperation)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MOperation_type") :
			getString("_UI_MOperation_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MOperation.class)) {
			case MecorePackage.MOPERATION__MULTIPLICITY:
			case MecorePackage.MOPERATION__TYPE_PARAMETERS:
			case MecorePackage.MOPERATION__PARAMETERS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MecorePackage.Literals.MTYPE_PARAMETRIZABLE__TYPE_PARAMETERS,
				 MecoreFactory.eINSTANCE.createMTypeParameter()));

		newChildDescriptors.add
			(createChildParameter
				(MecorePackage.Literals.MOPERATION__PARAMETERS,
				 MecoreFactory.eINSTANCE.createMParameter()));
	}
