    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         MecorePackage.Literals.MANNOTATION__SOURCE,
         true,
         false,
         false,
  ...
  {
    String label = ((MAnnotation)object).getSource();
    return label == null || label.length() == 0 ?
      getString("_UI_MAnnotation_type") :
      getString("_UI_MAnnotation_type") + " " + label;
  }
  ...
  public void notifyChanged(Notification notification)
  {
    ...
    {
      case MecorePackage.MANNOTATION__SOURCE:
