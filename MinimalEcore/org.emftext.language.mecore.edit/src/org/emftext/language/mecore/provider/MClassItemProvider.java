...
/**
 * This is the item provider adapter for a {@link org.emftext.language.mecore.MClass} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addAbstractPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MClass_abstract_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MClass_abstract_feature", "_UI_MClass_type"),
				 MecorePackage.Literals.MCLASS__ABSTRACT,
				 true,
				 false,
				 false,
	...
	protected void addInterfacePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MClass_interface_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MClass_interface_feature", "_UI_MClass_type"),
				 MecorePackage.Literals.MCLASS__INTERFACE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		newChildDescriptors.add
			(createChildParameter
				(MecorePackage.Literals.MCLASS__SUPER_TYPE_REFERENCES,
				 MecoreFactory.eINSTANCE.createMTypeReference()));
	}
